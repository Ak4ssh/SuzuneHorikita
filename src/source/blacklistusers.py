...
import html
import src.source.sql.blacklistusers_sql as sql
from src import (
    DEVS,
    Owner,
    DRAGONS,
...
BLACKLISTWHITELIST = [Owner] + DEVS + DRAGONS + WOLVES + DEMONS
BLABLEUSERS = [Owner] + DEVS
...
inline = "Blacklisting Users"
hndrl = [BL_HANDLER, UNBL_HANDLER, BLUSERS_HANDLER]
