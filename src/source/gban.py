...
from src.source.helper_funcs.misc import send_to_list
...
inline = "Anti-Spam"
hndrl = [GBAN_HANDLER, UNGBAN_HANDLER, GBAN_LIST, GBAN_STATUS]

if STRICT_GBAN:  # enforce GBANS if this is set
    dispatcher.add_handler(GBAN_ENFORCER, GBAN_ENFORCE_GROUP)
    hndrl.append((GBAN_ENFORCER, GBAN_ENFORCE_GROUP))
