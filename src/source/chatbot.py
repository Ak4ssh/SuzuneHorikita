...
import html
import requests
import src.source.sql.chatbot_sql as sql
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get(f'https://apikatsu.otakatsu.studio/api/chatbot/cleverbot?name=Miku&owner=Ezio&message='+Message)
...
__help__ = """
◉ Miku AI is the only ai system which can detect only 'English' Language
