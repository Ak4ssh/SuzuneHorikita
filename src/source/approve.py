...
from src import dispatcher, DRAGONS
from src.source.helper_funcs.extraction import extract_user
from telegram.ext import CallbackContext, CallbackQueryHandler
import src.source.sql.approve_sql as sql
...
inline = "Approvals"
cmd = ["approve", "unapprove", "approved", "approval"]
hndrl = [APPROVE, DISAPPROVE, APPROVED, APPROVAL]
