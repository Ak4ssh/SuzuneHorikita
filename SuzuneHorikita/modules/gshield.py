...
from SuzuneHorikita.services.telethonbasics import is_admin
from SuzuneHorikita.events import register
from pymongo import MongoClient
from SuzuneHorikita.modules.sql.nsfw_watch_sql import (
    add_nsfwatch,
    get_all_nsfw_enabled_chat,
    is_nsfwatch_indb,
    rmnsfwatch,
)
from SuzuneHorikita import telethn as tbot, MONGO_DB_URI, BOT_ID
