...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text("Bhai,Bhen jo bhi ho apke pass ye right na ha sorry aur so sameless you are saste admin  🙂 dil se bura laga ")
        return
...
def lowpromote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text("Bhai,Bhen jo bhi ho apke pass ye right na ha sorry 🙂 dil se bura laga  ")
        return
