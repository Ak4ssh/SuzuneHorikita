...
from SuzuneHorikita import BOT_USERNAME as bu
from SuzuneHorikita import BOT_ID, pbot, arq
from SuzuneHorikita.ex_plugins.chatbot import add_chat, get_session, remove_chat
from SuzuneHorikita.utils.pluginhelper import admins_only, edit_or_reply
...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("@Suzunesupport", "Suzunebot.ai")
        test = test.replace("I live in @Suzunesupport.", "I live in San Francisco, California.")
        ...
        response = response.replace("I live in San Francisco, California.", "I live in @Suzunesupport.")
        ...
        response = response.replace("I'm married to my job.", "I'm married with @excrybaby")
        response = response.replace("I'm single.", "My husband is @excrybaby")
        response = response.replace("Suzunebot.ai", "@Suzunesupport")
...
@pbot.on_message(filters.regex("Suzune|Suzune|robot|Suzune|sena") & ~filters.bot & ~filters.via_bot  & ~filters.forwarded & ~filters.reply & ~filters.channel & ~filters.edited)
async def inuka(client, message):
    msg = message.text
    if msg.startswith("/") or msg.startswith("@"):
        message.continue_propagation()
